<a id="btn_load_databases" data-role="none" onClick="cg_loadDatabases();" href="#" class="btn">cg_loadDatabases</a>
<a id="btn_load_tables" data-role="none" onClick="cg_loadTables();" href="#" class="btn">cg_loadTables</a>
<a id="btn_load_tables" data-role="none" onClick="cg_generateConfig();" href="#" class="btn">cg_generateConfig</a>


<ul class="nav nav-tabs" id="codegen_tabs">
  <li class="active"><a href="#codegen_pane" data-toggle="tab">codegen</a></li>
  <li><a href="#step2_pane" data-toggle="tab">step2</a></li>
  <li><a href="#step3_pane" data-toggle="tab">step3</a></li>
  <li><a href="#step4_pane" data-toggle="tab">step4</a></li>
  <li><a href="#step5_pane" data-toggle="tab">step4</a></li>
  <li><a href="#step6_pane" data-toggle="tab">step4</a></li>
</ul><!--/tabs-->
 
<div class="tab-content">
  <div class="tab-pane active" id="codegen_pane">…</div>
  <div class="tab-pane" id="step2_pane">…</div>
  <div class="tab-pane" id="step3_pane">…</div>
  <div class="tab-pane" id="step4_pane">…</div>
  <div class="tab-pane" id="step5_pane">…</div>
  <div class="tab-pane" id="step6_pane">…</div>
</div><!--/tabcontent-->
...
<div class="ui-block">
    <div class="cg_box ui-content">
        <div class="cg_box_content">
            <form id="cg_step_1" action="none.html" method="get" class="cg_form form-horizontal">
                <ul id="cg_generator_database_form_list" data-role="listview" data-inset="true">
                    ...
                    <li>
                        <fieldset data-role="fieldcontainer"></fieldset>
                    </li>
                </ul>
            </form>
        </div>
...
<div class="cg_box ui-content">
    <div class="cg_box_content">
        <form id="cg_step_2" action="none.html" method="get" class="cg_form form-horizontal">
            <ul id="cg_generator_appinfo_form_list" data-role="listview" data-inset="true">
                ...
                <li>
                    <fieldset data-role="fieldcontain">
                        <label for="txt_databases"> Database: </label>
                ...
                <li>
                    <fieldset data-role="fieldcontain">
                        <label for="txt_tables" class="select"> Tables: </label>
                ...
                <li>
                    <fieldset data-role="fieldcontain">
                        <label for="txt_endpoint"> Endpoint: </label>
                ...
                <li>
                    <fieldset data-role="fieldcontain">
                        <a id="btn_generateApp" data-role="button" data-theme="c" href="#" class="btn btn-primary" onClick="cg_createApplication()">Create Application</a>
                    </fieldset>
                </li>
            </ul>
        </form>
...
<div class="cg_box ui-content" data-role=" ">
    <div class="cg_box_content" >
        <form id="cg_step_3" action="none.html" method="get" class="cg_form form-horizontal">
            <ul id="cg_generator_appreview_form_list" data-role="listview" data-inset="true">
                ...
                <li>
                    <fieldset data-role="fieldcontain">
                        <a href="#" class="btn btn-primary" data-role="button" data-theme="c" id="btn_generateApp" onClick="cg_saveApplication()">Save Application</a>
                    </fieldset>
                </li>
            </ul>
        </form>
